...
void smacc_domain_optimization_visitor::visit(network* a)
{
...
void smacc_domain_optimization_visitor::validate_invariants(const node* n)
{
...
void smacc_domain_optimization_visitor::collect_node_data(node* n)
{
...
void smacc_domain_optimization_visitor::visit(node* n)
{
...
void smacc_domain_optimization_visitor::visit(edge* e)
{
...
void smacc_domain_optimization_visitor::visit(constraint* c)
{
...
void smacc_domain_optimization_visitor::visit(clock_var* cv)
{
...
void smacc_domain_optimization_visitor::visit(update* u)
{
...
void smacc_domain_optimization_visitor::visit(expr* ex)
{
...
void smacc_domain_optimization_visitor::clear()
{
    visitor::clear();
    this->node_count_ = 0;
...
unsigned smacc_domain_optimization_visitor::get_max_expr_depth() const
{
    return max_expr_depth_;
}

bool smacc_domain_optimization_visitor::has_invalid_constraint() const
{
    return this->contains_invalid_constraint_;
}

unsigned smacc_domain_optimization_visitor::get_max_fanout() const
{
    return this->max_edge_fanout_;
}

unsigned smacc_domain_optimization_visitor::get_node_count() const
{
    return this->node_count_;
}

std::unordered_map<int, node*> smacc_domain_optimization_visitor::get_node_map() const
{
    return {this->node_map_};
}


bool smacc_domain_optimization_visitor::is_goal(const int node_id) const
{
...
unsigned smacc_domain_optimization_visitor::count_expr_depth(const expr* ex)
{
...
void smacc_domain_optimization_visitor::compound_optimize_constraints(edge* e)
{
...
expr* smacc_domain_optimization_visitor::interleave_updates_in_expr(expr* ex, const arr<update>& updates)
{
    if(ex == nullptr) return nullptr;
...
bool smacc_domain_optimization_visitor::expr_contains_clock(const expr* ex)
{
...
inline bool smacc_domain_optimization_visitor::is_const_expr(const expr* ex)
{
...
bool smacc_domain_optimization_visitor::is_const_constraint(const constraint* con)
{
...
bool smacc_domain_optimization_visitor::evaluate_const_constraint(const constraint* con)
{
...
double smacc_domain_optimization_visitor::evaluate_const_expr(const expr* ex)
{
    double temp;
    switch (ex->operand)
    {
...
void smacc_domain_optimization_visitor::reduce_constraint_set(arr<constraint>* con_array)
{
...
void smacc_domain_optimization_visitor::reduce_expr(expr* ex)
{
